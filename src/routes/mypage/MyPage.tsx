...
export default function MyPage() {
  ...
  const handlePasswordSubmit = async (e: React.FormEvent) => {
    ...
    if (newPassword.length < 8)
      errs.next = "새 비밀번호는 8자 이상이어야 합니다.";
      ...
      >
        ...
        <div
          style={{
            ...
            gap: "20px",
            background:
              "linear-gradient(135deg, rgba(0,102,255,0.04) 0%, rgba(77,148,255,0.04) 100%), var(--semantic-background-normal-normal)",
          }}
        >
          <div
            style={{
        ...
        <Section title="비밀번호 변경">
          ...
          >
            <FormField flexDirection="column" gap="6px">
              ...
              />
              {pwErrors.current && (
                <FormErrorMessage>{pwErrors.current}</FormErrorMessage>
              )}
            </FormField>
            ...
            <FormField flexDirection="column" gap="6px">
              ...
              />
              {pwErrors.next && (
                <FormErrorMessage>{pwErrors.next}</FormErrorMessage>
              )}
            </FormField>
            ...
            <FormField flexDirection="column" gap="6px">
              ...
              />
              {pwErrors.confirm && (
                <FormErrorMessage>{pwErrors.confirm}</FormErrorMessage>
              )}
            </FormField>
        ...
        >
          ...
          >
            계정을 삭제하면 모든 구독 데이터가 영구적으로 삭제되며 복구할 수
            없습니다.
          </Typography>
            ...
            >
              ...
              >
                <Typography variant="body2" style={{ color: "#b91c1c" }}>
                  ⚠️ 이 작업은 되돌릴 수 없습니다. 계속하려면 비밀번호를
                  입력하세요.
                </Typography>
              </div>
              <FormField flexDirection="column" gap="6px">
